...
if iInvCounterRand <= 0 && instance_nearest(x,y,objNetRand).iNetDiffPlayer <= 0 && instance_nearest(x,y,objNetRand).iNetDiffSnake <= 0//objPlayer.iInvCounterPlayerRand <= 0 //|| objPlayer.bNet == true //&& bCaughtNetRand == false //&& instance_nearest(self.x,self.y,objNetRand).iInvCounterRand <= 0
{
	bCaughtNetRand = true;
}
else 
